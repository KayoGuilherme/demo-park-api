...
public class VagaController {
    ...
    @PutMapping("/{codigo}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Void> updateWaveByCodigo(@PathVariable Long id, @RequestBody @Valid VagaDto data) {
        Vaga vaga = vagaService.updateWave(id, data.getCodigo(), data.getStatus());
